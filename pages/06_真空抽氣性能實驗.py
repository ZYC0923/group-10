...
# 設定文件路徑
file_paths = {
    "docx": "files/實驗6.真空抽氣性能實驗.docx",  # 真空抽氣性能實驗 DOCX
    "pdf": "files/實驗6.真空抽氣性能實驗.pdf",  # 真空抽氣性能實驗 PDF
    "xls": "files/實驗6.真空抽氣性能實驗.xls"  # 真空抽氣性能實驗 Excel 文件
}
...
if "pdf" in file_paths and os.path.exists(file_paths["pdf"]):
    st.subheader("實驗6: 真空抽氣性能實驗.pdf 內容")
