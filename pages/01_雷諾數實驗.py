...
# 設定文件路徑
file_paths = {
    "pdf": "files/實驗1.雷諾數實驗.pdf",  # 雷諾數實驗PDF
    "docx": "files/實驗1.雷諾數實驗.docx",  # 雷諾數實驗DOCX
    "xls": "files/實驗1.雷諾數實驗.xls"   # 雷諾數實驗Excel文件
}
