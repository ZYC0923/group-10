...
# 設定文件路徑
file_paths = {
    "docx": "files/實驗3.伯努利文氏管實驗.docx",  # 柏努利文氏管實驗 DOCX
    "pdf": "files/實驗3.伯努利文氏管實驗.pdf"  # 柏努利文氏管實驗 PDF
}
...
for file_type, path in file_paths.items():
    if os.path.exists(path):  # 檢查文件是否存在
        ...
        if file_type == "pdf":
            ...
            label = "下載 實驗3.柏努利文氏管實驗.pdf"
        elif file_type == "docx":
            mime_type = "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
            label = "下載 實驗3.柏努利文氏管實驗.docx"
...
if "pdf" in file_paths and os.path.exists(file_paths["pdf"]):
    st.subheader("實驗3: 柏努利文氏管實驗.pdf 內容")
