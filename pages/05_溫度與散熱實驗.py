...
# 設定文件路徑
file_paths = {
    "docx": "files/實驗5.溫度與散熱實驗.docx",  # 溫度與散熱實驗 DOCX
    "pdf": "files/實驗5.溫度與散熱實驗.pdf",  # 溫度與散熱實驗 PDF
    "xls": "files/實驗5.溫度與散熱實驗.xls"  # 溫度與散熱實驗 Excel 文件
}
...
for file_type, path in file_paths.items():
    if os.path.exists(path):  # 檢查文件是否存在
        ...
        if file_type == "pdf":
            ...
            label = "下載 實驗5.溫度與散熱實驗.pdf"
        elif file_type == "docx":
            mime_type = "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
            label = "下載 實驗5.溫度與散熱實驗.docx"
        elif file_type == "xls":
...
if "pdf" in file_paths and os.path.exists(file_paths["pdf"]):
    st.subheader("實驗5: 溫度與散熱實驗.pdf 內容")
